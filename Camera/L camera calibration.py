...
squareLength = 0.04
markerLength = 0.02
output_file = "calibration_values.yml"

# ZED camera initialization (left camera)
...
while True:
    ...
    if zed.grab(runtime_parameters) == sl.ERROR_CODE.SUCCESS:
        ...
        if len(left_image_opencv.shape) == 3:
            gray = cv2.cvtColor(left_image_opencv, cv2.COLOR_BGR2GRAY)
        else:
            gray = left_image_opencv
